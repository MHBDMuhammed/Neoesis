...
import { EnhancedLessonNav } from './EnhancedLessonNav';
...
interface EnhancedLessonLayoutProps {
  lesson: {
    meta: LessonMeta;
...
/**
 * EnhancedLessonLayout - Phase 2 upgraded lesson layout
 *
 * New features:
 * - Focus Mode (full-screen reader)
 * - Reader Settings (font, theme, width)
 * - Sticky TOC (auto-generated from headings)
 * - Enhanced Navigation (rich cards)
 * - Notes Panel
 * - Text Highlighter
 * - Sidebar toggle controls
 */
export function EnhancedLessonLayout({
  lesson,
  children,
}: EnhancedLessonLayoutProps) {
      ...
      >
        ...
        <div className="space-y-8 px-6 py-6">
          ...
          <div>
            ...
            <EnhancedLessonNav current={lesson} />
          </div>
        </div>
      </motion.aside>
